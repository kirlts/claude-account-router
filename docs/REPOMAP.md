...
| `bin/` | The three executables: the wrapper the editor invokes, the account console, the verifier. | When changing what the router decides, what the console operates on, or what the verifier measures. Read `lib/` first. |
